...
Core/Src/intefaceCasm.o: ../Core/Src/intefaceCasm.s Core/Src/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m3 -g3 -c -x assembler-with-cpp -MMD -MP -MF"Core/Src/intefaceCasm.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@" "$<"
